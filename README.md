...
- Workflow настроен на часовую синхронизацию
...
1. Доступность CMS и Report API
2. Корректность подключения к PostgreSQL
3. Соответствие структуры таблицы `spare_parts` ожидаемой схеме
4. Логи выполнения в интерфейсе n8n